...
class Wordcloud:
    wc = WordCloud(font_path='malgun', width=400, height=400, scale=2.0, max_font_size=250, background_color="rgba(255, 255, 255, 0)", mode="RGBA")
    ...
    def __new__(cls, text):
        ...
        return open("tmp_wordcloud.png", "rb").read()
